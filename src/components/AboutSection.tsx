...
const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-24 px-6 relative overflow-hidden">
      ...
      {/* UFO illustration - optimized for mobile */}
      <div className={`absolute ${isMobile ? 'bottom-10 left-0 w-24 opacity-40 -z-5' : 'bottom-20 left-[10%] w-40 md:w-52 xl:w-64 z-10'} animate-ufo`}>
      ...
      {/* Mini code snippets scattered around - OPTIMIZED FOR MOBILE */}
      <div className={`absolute ${isMobile ? 'top-12 -left-4 scale-75 opacity-30 -z-5' : 'top-40 left-20 z-10'} code-snippet-mini animate-float-element`} style={{
        animationDelay: "1.3s"
      }}>
  ...
  if (player.x > width) {
    player.x = 0;
      ...
      <div className={`absolute ${isMobile ? 'bottom-14 right-0 scale-75 opacity-30 -z-5' : 'bottom-44 right-28 z-10'} code-snippet-mini animate-float-element`} style={{
        animationDelay: "2.7s"
      }}>
...
updateUI(score);`}
      ...
      <div className={`absolute ${isMobile ? 'top-20 right-0 scale-75 opacity-30 -z-5' : 'top-64 right-48 z-10'} code-snippet-mini animate-float-element`} style={{
        animationDelay: "3.5s"
      }}>
  ...
  gameData,
  {
    ...
    batchSize: 32
      ...
      <div ref={sectionRef} className="container mx-auto max-w-6xl section-animate z-10 relative">
